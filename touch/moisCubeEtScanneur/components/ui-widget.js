...
/***/ (function(module, exports) {
    ...
    init: function () {
	    var indicator = new THREE.Mesh(new THREE.BoxGeometry( 0.02, 0.01, 0.4 ), new THREE.MeshLambertMaterial({color: 0xff3333}))
	    indicator.position.z = -0.105;
	    indicator.position.y = 0.04;

	    knob = new THREE.Mesh(new THREE.CylinderGeometry( 0.1, 0.1, 0.1, 20 ), new THREE.MeshLambertMaterial({color: 0x666666}));
	    knob.add(indicator);
